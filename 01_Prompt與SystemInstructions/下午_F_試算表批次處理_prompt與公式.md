...
// 模型名稱請以 Google AI Studio 當前提供者為準（2026 現況預設如 gemini-3.1-flash-lite；亦有 gemini-2.5-flash 等）。
...
- **坑 2：模型名稱過期** → Google 模型名稱會更新。以 **AI Studio 當前提供的模型**為準（2026 現況如 `gemini-3.1-flash-lite` / `gemini-2.5-flash`）。
